...
export function sidecarPaths() {
  ...
  return {
    ...
    nativeBridgeRequestDir: join(root, 'runtime', 'native', 'bridge.request-queue'),
    nativeBridgeResponseDir: join(root, 'runtime', 'native', 'bridge.response-queue'),
    ...
    nativeBridgeValidationFile: join(root, 'runtime', 'native', 'bridge.validation.json'),
    nativeBridgeValidationLogFile: join(root, 'logs', 'bridge-validation.jsonl'),
