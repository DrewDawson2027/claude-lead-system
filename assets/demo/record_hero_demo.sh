...
# Shows the coordination loop - conflict detection, messaging, task reassignment
set -euo pipefail
...
echo -e "${GY}Session L-001 • claude-sonnet-4-5 • demo-project${R}"
echo -e "${GY}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${R}"
echo ""
printf "${B}${WH}> ${R}"
sleep 0.3
...
echo -e "${GY}│${R} L-001    ${GY}│${R} ${CY}● lead${R}       ${GY}│${R} sonnet ${GY}│${R} Orchestration             ${GY}│${R}"
echo -e "${GY}└──────────┴──────────────┴────────┴───────────────────────────┘${R}"
echo ""
sleep 0.4
...
echo ""
slow "  ${BL}tell${R} W-a8f3 to focus on JWT validation + token refresh only"
echo -e "  ${GR}✓${R} \"Focus on JWT validation + token refresh only\""
echo ""
slow "  ${BL}tell${R} W-c2e7 to switch to rate limiting"
echo -e "  ${GR}✓${R} \"Switch to rate limiting — create src/rate-limiter.ts\""
echo ""
sleep 0.4

echo -e "  ${BL}reassign${R} W-c2e7"
...
echo -e "${B}${GR}✓ All conflicts resolved.${R} Workers redirected via local inbox messaging."
echo ""
sleep 0.5

# Coordination view
echo -e "${B}Coordination View${R}  ${GY}(this session)${R}"
echo -e "${GY}┌──────────────────────────┬──────────────────────────────────────┐${R}"
echo -e "${GY}│${R} ${B}Coordination path${R}        ${GY}│${R} local state files + inbox delivery     ${GY}│${R}"
echo -e "${GY}│${R} ${B}Execution mode${R}           ${GY}│${R} coordinator                            ${GY}│${R}"
echo -e "${GY}│${R} ${B}Conflict handling${R}        ${GY}│${R} detect overlap, redirect work          ${GY}│${R}"
echo -e "${GY}│${R} ${B}Worker model${R}             ${GY}│${R} autonomous workers report back locally ${GY}│${R}"
echo -e "${GY}└──────────────────────────┴──────────────────────────────────────┘${R}"
echo ""
sleep 0.5
...
echo -e "  ${GR}✓${R} 2 directives sent via local inbox delivery"
echo -e "  ${GR}✓${R} 12/12 tests passing across both workers"
echo -e "  ${GR}✓${R} coordination state kept outside the main context window"
echo ""
