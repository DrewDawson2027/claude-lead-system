...
check_not_contains "no personal paths in settings"  "$REPO_ROOT/settings/settings.local.json" "/Users/[a-zA-Z]"

echo ""
echo "Heartbeat hook contract:"
check_not_contains "no personal paths in heartbeat" "$REPO_ROOT/hooks/terminal-heartbeat.sh" "/Users/"
...
check_not_contains "no personal paths in token-guard"       "$REPO_ROOT/hooks/token-guard.py" "/Users/[a-zA-Z]"
check_not_contains "no personal paths in read-efficiency"   "$REPO_ROOT/hooks/read-efficiency-guard.py" "/Users/[a-zA-Z]"
check_not_contains "no personal paths in lead.md"           "$REPO_ROOT/commands/lead.md" "/Users/[a-zA-Z]"
