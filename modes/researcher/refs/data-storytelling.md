...
4. **Climax**: The key insight — the "aha" moment
5. **Resolution**: What this means — actionable recommendations
...
- **Audience-calibrate**: executives want implications, analysts want methodology
- **Start with "so what"** — lead with the recommendation, then prove it
- **Use comparison**: vs last period, vs target, vs competitor, vs industry benchmark
